            ...
            <div className="container">
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    <p className="text-xl text-muted-foreground mb-10">
                        Access powerful calculators and portfolio tracking tools to plan your financial future.
                    </p>
                    <div className="grid md:grid-cols-2 gap-6">
                        <Link to="/calculators" className="group p-6 border rounded-lg hover:border-primary">
                        ...
                        <Link to="/portfolios" className="group p-6 border rounded-lg hover:border-primary">
